...
class catalogo : AppCompatActivity() {
    ...
    fun cargarSeries() {
        series.add(Pelicula("Avatar: La leyenda de Aang", R.drawable.avatar, R.drawable.avatar, "La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego."))
        ...
        series.add(Pelicula("El Monstruo de la Vieja Séul", R.drawable.elmonstruo, R.drawable.elmounstruos, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana."))
    ...
    class PeliculaAdapter: BaseAdapter {
        ...
        override fun getView(pe: Int, p1: View?, p2: ViewGroup?): View {
            ...
            var image: ImageView = vista.findViewById(R.id.movieCell)
            var title: TextView = vista.findViewById(R.id.movieTitleCell)
